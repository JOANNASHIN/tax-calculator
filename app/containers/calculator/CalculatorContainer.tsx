  ...
  return (
    <>
      ...
      <Survey>
        ...
        <Survey.Tip>
          *그 밖의 인적공제란? 자녀공제, 미성년자공제, 연로자공제, 장애인공제를 의미합니다. *그 밖의 인적공제 합계금액이
          3억원 미만인 경우 일괄공제가 유리합니다. *일괄공제란? MAX [ ①일괄공제(5억) , ②(기초공제(2억)+그밖의인적공제) ]
          * '아니오' 선택시 일괄공제가 적용됩니다. (단, 배우자단독상속인경우는 일괄공제 적용안됨) 적용가능한
          물적상속공제를 선택하세요
        </Survey.Tip>
      </Survey>
